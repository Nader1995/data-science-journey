...
DESCRIBE employee; -- branch, branch_supplier, client, 
				   -- employee, works_with

/* 		
  	Tables branch and employee are parent/child of each other.
 	We can NOT delete one before deleting the other, so first
 	we de-activate foreign_key_check and delete tables, then
...
SELECT * FROM branch_supplier; -- employee, branch, works_with, client, branch_supplier
...
DROP TRIGGER trigger_two;
DROP TRIGGER trigger_three;
...
VALUES('added new employee - without delimiter');
...
BEGIN
	...
	ELSE 
		INSERT INTO trigger_test VALUES('Added wrong gender');
	END IF;
END @@
...
FOR EACH ROW 
	BEGIN
        INSERT INTO trigger_test VALUES('added new employee - with delimiter');
    END$$
...
INSERT INTO employee VALUES(110, 'Kevin', 'Malone', '1978-02-19', 'L', 69000, 106, 3);
INSERT INTO employee VALUES(111, 'Nasim', 'Safari', '1995-01-08', 'F', 69000, 106, 3);
